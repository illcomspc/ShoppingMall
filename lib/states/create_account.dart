...
class _CreateAccountState extends State<CreateAccount> {
  ...
  Future<Null> checkPermission() async {
    ...
    if (locationService) {
      ...
      MyDialog().alertLocationService(
          context, 'Location Service ປິດຢູ່ ?', 'ກະລຸນາເປີດ Location ນຳ');
    }
  }
      ...
      onPressed: () {
        if (formKey.currentState!.validate()) {
          if (typeUser == null) {
            ...
            MyDialog().normalDialog(context, 'ຍັງບໍ່ໄດ້ເລືອກຊະນິດຂອງຜູ້ໃຊ້',
                'ກະລຸນາເລືອກແທັບ ທີ່ຊະນິດຂອງຜູ້ໃຊ້ຕ້ອງາການ');
          } else {
  ...
  ShowTitle buildSubTitle() {
    return ShowTitle(
      title:
          'ຮູບພາບທີ່ສະແດງຄວາມເປັນຕົວຕົນຂອງ User (ແຕ່ຖ້າບໍ່ສະດວກແຊ ເຮົາຈະສະແດງພາບ default ແທນ)',
